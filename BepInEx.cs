...
using QuickMenu = UIElement1PublicVeTrVeGaSpVeGaObStVeUnique;
using UiTooltip = MonoBehaviourPublicIPointerEnterHandlerIEventSystemHandlerIPointerExitHandler1StBoStBo1StBoStStUnique;
