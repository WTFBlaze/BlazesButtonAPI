...
namespace ApolloCore.API.QM
{
    public class QMNestedButton : QMMenuBase
    {
        ...
        public void OpenMe()
        {
            ...
            APIUtils.MenuStateControllerInstance.Method_Public_Void_String_ObjectPublicStBoAc1ObObUnique_Boolean_EnumNPublicSealedvaNoLeRiBoIn6vUnique_0(MenuPage.field_Public_String_0, null, false, EnumNPublicSealedvaNoLeRiBoIn6vUnique.Left);
        }
